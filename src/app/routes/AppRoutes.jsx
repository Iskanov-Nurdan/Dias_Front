...
const AppRoutes = () => (
  <Routes>
    ...
    <Route
      ...
      element={<Navigate to="/prepare-blanks/:blankId" replace />}
    />
    <Route
      path="/prepare-blanks/:blankId"
      element={(
    ...
    >
      ...
      {STAGE2_TABS_ENABLED && (
        <>
          ...
          <Route path="payments" element={<Navigate to="/cash/sales" replace />} />
          ...
          <Route path="cash/returns" element={<Navigate to="/cash/sales" replace />} />
          <Route path="cash/payments" element={<Navigate to="/cash/sales" replace />} />
          <Route path="cash/defects" element={<Navigate to="/cash/sales" replace />} />
          <Route path="cash/defects/rework" element={<Navigate to="/cash/sales" replace />} />
