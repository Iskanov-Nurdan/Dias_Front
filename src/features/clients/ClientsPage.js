...
const ClientsPage = () => {
  ...
  return (
    <div className="clients-page">
      ...
      <ClientsList items={items} loading={loading} error={error} onRetry={fetchSafe} onAdd={() => setFormClient({})} onEdit={setFormClient} onDelete={setConfirmDelete} onDetails={handleOpenCard} onExtend={setExtendClientObj} />
      ...
      {cardClient && <ClientCardModal client={cardClient} onEdit={setFormClient} onDelete={setConfirmDelete} onExtend={setExtendClientObj} onClose={() => setCardClient(null)} />}
