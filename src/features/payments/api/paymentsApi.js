...
export const getPaymentsSummary = (clientId) => apiClient.get('payments/summary/', { params: { client_id: clientId } });
export const getPaymentSelectSources = (params = {}) => apiClient.get('payments/select-sources/', { params });
