  ...
  return (
    <div className="page page--plastic-profiles">
      ...
      <p className="plastic-profiles__lede">
        Профиль — тип продукции и точка входа: сначала профиль, затем рецепт(ы), затем производство. Без рецепта производить нельзя. На одном профиле может быть несколько рецептов (версии); в партии выбирается один рецепт.
      </p>
