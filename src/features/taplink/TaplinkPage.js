  ...
  return (
    <div className={pageClass}>
      ...
      <header className="tp-header">
        {/* Тот же герб, что в favicon (красный круг, белая R), но со своим
            прозрачным фоном, а не непрозрачным тёмно-синим квадратом —
            у favicon фон нужен нарочно (иначе Google рисует иконку криво),
            а здесь, на самой странице, за ней и так тёмная шапка — квадрат
            вокруг герба смотрелся бы отдельной плашкой поверх фона. */}
        <img
          src="/logo-mark.png"
          alt="Рахман Ата"
      ...
      <footer className="tp-footer">
        ...
        {/* Вход для сотрудников — раньше открывался только тем, кто вручную
            набирал /login в адресной строке, а сотрудники этого адреса не
            знали и не могли попасть в свой аккаунт. Ссылка намеренно тихая
            (внизу, мелким шрифтом, за разделителем) — это служебный вход,
            не то, что должно отвлекать посетителя от записи. */}
        <a href="/login" className="tp-footer__staff-login">
