...
/** Общие SVG-иконки навигации (Lucide-style), 18×18 в сайдбаре. */
export const NavIcons = {
  ...
  /** Заказы — список на бланке (рядом с производством в ERP). */
  ClipboardList: () => (
    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
  ...
  Truck: () => (
    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
      ...
      <path d="M15 18h2" />
      <path d="M19 18h2v-3.34a4 4 0 0 0-1.17-2.83L19 9h-5" />
...
/** Иконка пункта меню по ключу доступа (как в сайдбаре + недостающие ключи для модалки). */
